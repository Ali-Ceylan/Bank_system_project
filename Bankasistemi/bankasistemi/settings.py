"""
Django settings for bankasistemi project.
...
SECRET_KEY = 'django-insecure-*n5rvlcm8@x_b5gc^!j!#@4@asrxjwt^o0y-aeg1^3zgoc9d%)'
...
ROOT_URLCONF = 'bankasistemi.urls'
...
WSGI_APPLICATION = 'bankasistemi.wsgi.application'
